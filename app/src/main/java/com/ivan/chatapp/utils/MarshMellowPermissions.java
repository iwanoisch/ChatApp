...
public class MarshMellowPermissions {
    ...
    public void requestPermissionForReadExternalStorage(){
        if (ActivityCompat.shouldShowRequestPermissionRationale(mActivity,Manifest.permission.READ_EXTERNAL_STORAGE)){
            Toast.makeText(mActivity," External Storage permission is needed. Please turn it on inside the settins",
    ...
    public void requestPermissionForWriteExternalStorage(){
        if (ActivityCompat.shouldShowRequestPermissionRationale(mActivity,Manifest.permission.WRITE_EXTERNAL_STORAGE)){
            Toast.makeText(mActivity," Write Storage permission is needed. Please turn it on inside the settins",
                    Toast.LENGTH_SHORT).show();
        } else {
    ...
    public void requestPermissionForCamera(){
        if (ActivityCompat.shouldShowRequestPermissionRationale(mActivity,Manifest.permission.CAMERA)){
            Toast.makeText(mActivity," Camera Storage permission is needed. Please turn it on inside the settins",
                    Toast.LENGTH_SHORT).show();
        } else {
